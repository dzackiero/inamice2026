                    ...
                    <div className="flex flex-col sm:flex-row gap-16 lg:gap-24 w-full lg:w-auto">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-3">
                                {/* Whatsapp SVG */}
                                <a href="https://www.ticket2u.id/event/49337_962c67fd8ae94ed896db20dd98a052a9" target="_blank" rel="noopener noreferrer" className="hover:text-white/80 transition-colors" aria-label="Contact us on WhatsApp">
