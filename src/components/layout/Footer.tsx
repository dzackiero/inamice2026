                ...
                <div className="flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-8 mb-16">
                    ...
                    <div className="flex flex-col sm:flex-row gap-16 lg:gap-24 w-full lg:w-auto">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 font-medium text-[15px] text-white/90">
                                <li><a href="https://www.ticket2u.id/event/49337_962c67fd8ae94ed896db20dd98a052a9" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">How to Register</a></li>
                                <li><a href="https://www.ticket2u.id/event/49337_962c67fd8ae94ed896db20dd98a052a9" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Cancellation</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-3">
                                {/* Whatsapp SVG */}
                                <a href="https://wa.me/6285177876330" target="_blank" rel="noopener noreferrer" className="hover:text-white/80 transition-colors" aria-label="Contact us on WhatsApp">
                                ...
                                {/* Mail SVG */}
                                <a href="mailto:inamice@bisnis.pnj.ac.id" className="hover:text-white/80 transition-colors" aria-label="Send us an email">
                                ...
                                {/* Instagram SVG */}
                                <a href="https://www.instagram.com/inamice2026?igsh=c3E3OXNobzRibTI2" target="_blank" rel="noopener noreferrer" className="hover:text-white/80 transition-colors" aria-label="Follow us on Instagram">
                                ...
                                {/* TikTok SVG */}
                                <a href="https://www.tiktok.com/@inamice2026?_r=1&_t=ZS-96LXUVuXieO" target="_blank" rel="noopener noreferrer" className="hover:text-white/80 transition-colors" aria-label="Follow us on TikTok">
                                ...
                                {/* LinkedIn SVG */}
                                <a href="https://www.linkedin.com/in/inamice-indonesia-mice-conference-exhibition-1162952b4?utm_source=share_via&utm_content=profile&utm_medium=member_ios" target="_blank" rel="noopener noreferrer" className="hover:text-white/80 transition-colors" aria-label="Connect with us on LinkedIn">
                                    <svg className="w-[1.4rem] h-[1.4rem]" fill="currentColor" viewBox="0 0 24 24">
