                    ...
                    <div className="flex flex-col sm:flex-row gap-16 lg:gap-24 w-full lg:w-auto">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-3">
                                {/* Whatsapp SVG */}
                                <a href="https://wa.me/your-number" target="_blank" rel="noopener noreferrer" className="hover:text-white/80 transition-colors" aria-label="Contact us on WhatsApp">
